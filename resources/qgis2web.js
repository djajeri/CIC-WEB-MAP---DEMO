...
map.getView().fit([-17799315.612368, -2050885.490528, -17591134.614931, -1899817.979395], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Box Core and Trackplot - July 2025</h2>';
        return titleElement;
    })(),
